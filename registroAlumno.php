...
<div class="d-flex justify-content-center">
    <main class="login__registro">
        ...
        ?>
        <form method="POST" action="rAlumnosBD.php"  id="registroForm" onsubmit="return validateForm()">
            <h1 class="text-center h5 mb-3 fw-normal">Registro en Terminal Tracker <b>Alumno</b></h1>
            <div class="row g-3">
                <div class="col-sm-6">
