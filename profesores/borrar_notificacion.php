...
try {
    ...
    $query = "DELETE FROM notificaciones_profesores WHERE id = :id AND nEmpleado = :nEmpleado";
    $stmt = $pdo->prepare($query);
    $stmt->bindParam(':id', $notificacion_id, PDO::PARAM_INT);
    $stmt->bindParam(':nEmpleado', $_SESSION['user_id'], PDO::PARAM_STR);
    ...
    if ($stmt->execute()) {
        ...
        $_SESSION['error'] = "No se pudo eliminar la notificación.";
    }
